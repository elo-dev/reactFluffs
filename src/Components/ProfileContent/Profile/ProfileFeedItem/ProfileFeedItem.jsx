...
const ProfileFeedItem = (props) => {
    return(
        <div className={style.profileFeedItem}>
            ...
            <img onClick={props.onClick} src="https://images.pexels.com/photos/4646228/pexels-photo-4646228.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" alt="" />
        </div>
    )
}
